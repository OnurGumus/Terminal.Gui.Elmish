...
type prop =
    ...
    static member inline colorScheme(colorscheme: ColorScheme) =
        Interop.mkprop "colorScheme" colorscheme

    static member inline colorDisabled(forground: Color, background: Color) =
        Interop.mkprop "colorDisabled" <| Attribute.Make(forground, background)

    static member inline colorFocus(forground: Color, background: Color) =
        Interop.mkprop "colorFocus" <| Attribute.Make(forground, background)

    static member inline colorHotFocus(forground: Color, background: Color) =
        Interop.mkprop "colorHotFocus" <| Attribute.Make(forground, background)

    static member inline colorHotNormal(forground: Color, background: Color) =
        Interop.mkprop "colorHotNormal" <| Attribute.Make(forground, background)

    static member inline colorNormal(forground: Color, background: Color) =
        Interop.mkprop "colorNormal" <| Attribute.Make(forground, background)

    static member inline color(forground: Color, background: Color) =
        Interop.mkprop "color" <| Attribute.Make(forground, background)
...
module prop =
    ...
    module position =
        ...
        type x =
            ...
            static member inline percent(i: double) =
                Interop.mkprop "x" (Pos.Percent(i |> float32))
        ...
        type y =
            ...
            static member inline percent(i: double) =
                Interop.mkprop "y" (Pos.Percent(i |> float32))
    ...
    type width =
        ...
        static member inline fill(margin: int) =
            Interop.mkprop "width" (Dim.Fill margin)

        static member inline percent(percent: float) =
            Interop.mkprop "width" (Dim.Percent(percent |> float32))
    ...
    type height =
        ...
        static member inline fill(margin: int) =
            Interop.mkprop "height" (Dim.Fill margin)

        static member inline percent(percent: float) =
            Interop.mkprop "height" (Dim.Percent(percent |> float32))
    ...
    type textDirection =
        static member inline bottomTop_leftRight =
            Interop.mkprop "textDirection" TextDirection.BottomTop_LeftRight

        static member inline bottomTop_rightLeft =
            Interop.mkprop "textDirection" TextDirection.BottomTop_RightLeft

        static member inline leftRight_bottomTop =
            Interop.mkprop "textDirection" TextDirection.LeftRight_BottomTop

        static member inline leftRight_topBottom =
            Interop.mkprop "textDirection" TextDirection.LeftRight_TopBottom

        static member inline rightLeft_bottomTop =
            Interop.mkprop "textDirection" TextDirection.RightLeft_BottomTop

        static member inline rightLeft_topBottom =
            Interop.mkprop "textDirection" TextDirection.RightLeft_TopBottom

        static member inline topBottom_leftRight =
            Interop.mkprop "textDirection" TextDirection.TopBottom_LeftRight

        static member inline topBottom_rightLeft =
            Interop.mkprop "textDirection" TextDirection.TopBottom_RightLeft

    type verticalTextAlign =
        static member inline bottom = Interop.mkprop "textAlignment" VerticalTextAlignment.Bottom

        static member inline justified =
            Interop.mkprop "textAlignment" VerticalTextAlignment.Justified
...
type page =
    ...
    static member inline onAlternateForwardKeyChanged(value: Key -> unit) =
        Interop.mkprop "onAlternateForwardKeyChanged" value

    static member inline onAlternateBackwardKeyChanged(value: Key -> unit) =
        Interop.mkprop "onAlternateBackwardKeyChanged" value
...
type comboBox =
    ...
    static member inline onOpenSelectedItem(f: Terminal.Gui.ListViewItemEventArgs -> unit) =
        Interop.mkprop "onOpenSelectedItem" f

    static member inline onSelectedItemChanged(f: Terminal.Gui.ListViewItemEventArgs -> unit) =
        Interop.mkprop "onSelectedItemChanged" f
...
type dateField =
    ...
    static member inline onDateChanged(f: Terminal.Gui.DateTimeEventArgs<DateTime> -> unit) =
        Interop.mkprop "onDateChanged" f
...
type timeField =
    ...
    static member inline onTimeChanged(f: Terminal.Gui.DateTimeEventArgs<TimeSpan> -> unit) =
        Interop.mkprop "onTimeChanged" f
...
type hexView =
    ...
    static member inline onEdited(value: System.Collections.Generic.KeyValuePair<int64, byte> -> unit) =
        Interop.mkprop "cellSize" value
...
type listView =
    ...
    static member inline allowsMultipleSelection(value: bool) =
        Interop.mkprop "allowsMultipleSelection" value
...
type menubar =
    ...
    static member inline useKeysUpDownAsKeysLeftRight(value: bool) =
        Interop.mkMenuBarProp "useKeysUpDownAsKeysLeftRight" value

    static member inline useSubMenusSingleFrame(value: bool) =
        Interop.mkMenuBarProp "useSubMenusSingleFrame" value

    static member inline onMenuAllClosed(f: unit -> unit) =
        Interop.mkMenuBarProp "onMenuAllClosed" f

    static member inline onMenuClosing(f: Terminal.Gui.MenuClosingEventArgs -> unit) =
        Interop.mkMenuBarProp "onMenuClosing" f

    static member inline onMenuOpened(f: Terminal.Gui.MenuItem -> unit) = Interop.mkMenuBarProp "onMenuOpened" f

    static member inline onMenuOpening(f: Terminal.Gui.MenuOpeningEventArgs -> unit) =
        Interop.mkMenuBarProp "onMenuOpening" f

type menu =
    static member inline menuBarItem(props: IMenuProperty list) =
        (KeyValue("menubar", props)) :> IMenuBarItem // MenuElements.MenuBarItemElement(props) :> IMenuBarItem

    static member inline submenuItem(props: IMenuProperty list) =
        (KeyValue("submenuItem", props)) :> IMenu
    ...
    static member inline menuItem(title: string, action: unit -> unit) =
        let props = [ Interop.mkMenuProp "title" title; Interop.mkMenuProp "action" action ]
...
type progressBar =
    ...
    static member inline bidirectionalMarquee(value: bool) =
        Interop.mkprop "bidirectionalMarquee" value
...
module progressBar =
    ...
    type format =
        ...
        static member inline framedPlusPercentage =
            Interop.mkprop "progressBarFormat" ProgressBarFormat.FramedPlusPercentage

        static member inline framedProgressPadded =
            Interop.mkprop "progressBarFormat" ProgressBarFormat.FramedProgressPadded

        static member inline simple = Interop.mkprop "progressBarFormat" ProgressBarFormat.Simple

        static member inline simplePlusPercentage =
            Interop.mkprop "progressBarFormat" ProgressBarFormat.SimplePlusPercentage

    type style =
        static member inline blocks = Interop.mkprop "progressBarStyle" ProgressBarStyle.Blocks

        static member inline continuous =
            Interop.mkprop "progressBarStyle" ProgressBarStyle.Continuous

        static member inline marqueeBlocks =
            Interop.mkprop "progressBarStyle" ProgressBarStyle.MarqueeBlocks

        static member inline marqueeContinuous =
            Interop.mkprop "progressBarStyle" ProgressBarStyle.MarqueeContinuous

type radioGroup =
    static member inline selectedItem(value: int) = Interop.mkprop "selectedItem" value

    static member inline onSelectedItemChanged(f: SelectedItemChangedArgs -> unit) =
        Interop.mkprop "onSelectedItemChanged" f
...
type scrollView =
    ...
    static member inline autoHideScrollBars(value: bool) =
        Interop.mkprop "autoHideScrollBars" value

    static member inline keepContentAlwaysInViewport(value: bool) =
        Interop.mkprop "keepContentAlwaysInViewport" value

    static member inline showVerticalScrollIndicator(value: bool) =
        Interop.mkprop "showVerticalScrollIndicator" value

    static member inline showHorizontalScrollIndicator(value: bool) =
        Interop.mkprop "showHorizontalScrollIndicator" value
...
type tableView =
    ...
    static member inline onSelectedCellChanged(value: TableView.CellActivatedEventArgs -> unit) =
        Interop.mkprop "onSelectedCellChanged" value

    static member inline onCellActivated(value: TableView.CellActivatedEventArgs -> unit) =
        Interop.mkprop "onCellActivated" value

    static member inline cellActivationKey(value: Key) =
        Interop.mkprop "cellActivationKey" value
...
type tabView =
    ...
    static member inline onSelectedTabChanged(value: EventHandler<TabView.TabChangedEventArgs>) =
        Interop.mkprop "onSelectedTabChanged" value
...
type textField =
    ...
    static member inline onTextChanging(value: string -> unit) =
        Interop.mkprop "onTextChangingString" value
    ...
    static member inline desiredCursorVisibility(value: CursorVisibility) =
        Interop.mkprop "desiredCursorVisibility" value
...
type textView =
    ...
    static member inline selectionStartColumn(value: int) =
        Interop.mkprop "selectionStartColumn" value

    static member inline selectionStartRow(value: int) =
        Interop.mkprop "selectionStartRow" value
...
type treeView =
    ...
    static member inline allowLetterBasedNavigation(value: bool) =
        Interop.mkprop "allowLetterBasedNavigation" value

    static member inline selectedObject(value: ITreeNode) = Interop.mkprop "selectedObject" value

    static member inline onObjectActivated(value: ObjectActivatedEventArgs<ITreeNode> -> unit) =
        Interop.mkprop "onObjectActivated" value

    static member inline objectActivationKey(value: Key) =
        Interop.mkprop "objectActivationKey" value

    static member inline objectActivationButton(value: Nullable<MouseFlags>) =
        Interop.mkprop "objectActivationButton" value

    static member inline colorGetter(value: ITreeNode -> ColorScheme) = Interop.mkprop "colorGetter" value

    static member inline onSelectionChanged(value: SelectionChangedEventArgs<ITreeNode> -> unit) =
        Interop.mkprop "onSelectionChanged" value

    static member inline scrollOffsetVertical(value: int) =
        Interop.mkprop "scrollOffsetVertical" value

    static member inline scrollOffsetHorizontal(value: int) =
        Interop.mkprop "scrollOffsetHorizontal" value
